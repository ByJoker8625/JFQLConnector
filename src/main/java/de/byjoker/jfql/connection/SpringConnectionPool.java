...
public class SpringConnectionPool {
    ...
    public SpringConnectionPool() throws IOException {
        ...
        connection = new Connection(props.getProperty("de.byjoker.jfql.connection.host"), new User(props.getProperty("de.byjoker.jfql.connection.user"), props.getProperty("de.byjoker.jfql.connection.password")));
        connection.connect();
